...
#define AUTH "hh1tePs-bK-yonKyE65l-cbGwZ5bPC3L"  // You should get Auth Token in the Blynk App.  
#define WIFI_SSID "IIITL"                   //Enter Wifi Name
#define WIFI_PASS "iiitl@123"                   //Enter wifi Password
